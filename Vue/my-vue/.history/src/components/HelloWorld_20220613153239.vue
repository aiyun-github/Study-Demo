<template>
  <div>
  <button @click="show = !show">{{ show ? '编辑' : '查看' }}</button>
    <mavon-editor
      :toolbars="toolbars"
      ...
      v-show="show"
    />
    <article v-show="!show" class="markdown-body" style="text-align:left" v-html="content"></article>
  </div>
</template>
